...
const DepartmentTable: React.FC<DepartmentTableProps> = ({ data }) => {
  ...
  const sortedDinner = [...data].sort((a, b) => b.dinnerRequests - a.dinnerRequests).slice(0, 10);
  // Sort by Lunch Requests
  const sortedLunch = [...data].sort((a, b) => b.lunchRequests - a.lunchRequests).slice(0, 10);
